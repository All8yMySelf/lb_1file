...
- **Interface Toggles:**
  ...
  - **Music:** use the arrow buttons to cycle through tracks.
    The slider next to the selector controls volume, starting at 25%. Choose **Off** to disable the background music.
